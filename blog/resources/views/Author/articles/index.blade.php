        ...
        <div class="p-4 border-b border-gray-200 rounded-t-xl">
            ...
            <form id="filterForm" method="GET" action="{{ route('author.articles.index') }}"
                ...
                <div class="flex-1 min-w-[200px]">
                    ...
                    <input id="articleSearch" type="text" name="search" value="{{ request('search') }}"
                ...
                <div class="relative min-w-[200px]">
                    ...
                    "extraMarkup": "<div class=\"absolute top-1/2 end-3 -translate-y-1/2\"><svg class=\"shrink-0 size-3.5 text-gray-500\" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m7 15 5 5 5-5\"/><path d=\"m7 9 5-5 5 5\"/></svg></div>"
                        ...
                        <option value="all"
                            data-content="<div class='flex items-center w-full'><span class='text-gray-800'>Toutes les catégories</span></div>">
                            Toutes les catégories
                        </option>
                        @foreach($categories as $category)
                            <option value="{{ $category->slug }}" {{ request('category') == $category->slug ? 'selected' : '' }}
                                data-content="<div class='flex items-center w-full'><i data-lucide='{{ $category->icon }}' class='size-4 mr-2 {{ $category->color }}'></i><span class='text-gray-800'>{{ $category->name }}</span></div>">
                                {{ $category->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="relative min-w-[200px]">
                    ...
                    "extraMarkup": "<div class=\"absolute top-1/2 end-3 -translate-y-1/2\"><svg class=\"shrink-0 size-3.5 text-gray-500\" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"m7 15 5 5 5-5\"/><path d=\"m7 9 5-5 5 5\"/></svg></div>"
                        ...
                        <option value="all"
                            data-content="<div class='flex items-center w-full'><span class='text-gray-800'>Tous les statuts</span></div>">
                            Tous les statuts
                        </option>
