    ...
    <nav class="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
        ...
        <div id="navbar-collapse" class="hidden transition-all duration-300 basis-full grow sm:block">
            <div
                ...
                <!-- Articles Link -->
                <a class="inline-flex items-center gap-x-2 font-medium {{ Route::is('articles.search') ? 'text-blue-600 bg-blue-50 dark:bg-blue-900/20 dark:text-blue-500' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-800' }} py-2 px-3 rounded-lg transition-colors"
